 ...
 * 				Such a file must be copied into htdocs/mimodulo/core/modules directory.
 *  \file       htdocs/mymodule/core/modules/modMiModulo.class.php
 *  \ingroup    mymodule
...
class modMiModulo extends DolibarrModules {
    ...
    function __construct($db) {
        ...
        $this->description = "Módulo de prueba";
        ...
        $this->tabs = array('product:+mimodulo:MiModulo:mimodulo@mimodulo:/mimodulo/fiche.php?id=__ID__');
